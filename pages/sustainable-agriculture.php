...
<head>
    ...
    <style>
        ...
        /* --- Hero Section Styles --- */
        section.susAgri-hero {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6)), url(./assets/media/img/impact-areas/STA/sta-banner-img-1.jpg);
...
<body>
    ...
    <main>
        <!-- hero start -->
        <section class="susAgri-hero mb-5">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div
                        class="col-12 text-center text-white justify-content-center d-flex flex-column align-items-center gap-2">

                        <h1 class="fw-semibold mb-3 display-2">Sustainable Agriculture <br>& Food Security</h1>
                        <div style="width: 50%; max-width: 121.57px;  aspect-ratio: 1 / 1;"
                            class="d-flex justify-content-center overflow-hidden align-items-center">
                            <img src="./assets/icons/category large icon set (1).svg" alt="sustainable agriculture icon"
                                class="w-100 h-100 object-fit-cover">
                        </div>
                        <p class="fs-5 mt-3">Empowering local communities through sustainable micro enterprise development
        ...
        <div class="container my-5 problem" id="overview">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center overflow-hidden my-5">
                <div class="d-flex flex-column  pe-0 pe-md-5 w-100 justify-content-center py-4 text-start">
                    <h2 class="text-crimson fw-semibold mb-3">Sustainable Agriculture</h2>
                    <p>
                        <span class="fs-5 fw-semibold">Climate-smart and bio-intensive agricultural practices can
                            increase food productivity, improve
                            soil and water use efficiency, and enhance the income of farming
                            communities.</span></br></br>
                        Sri Lanka's national food security is under mounting pressure, driven by economic instability
                        and compounding climate challenges. According to the World Bank, "food insecurity remains
                        high, and poverty has nearly double to 23.4 percent in 2024," reflecting a critical need to
                        safeguard food systems. Key contributors to this crisis include surging costs of agricultural
                        inputs, persistent fertilizer shortages, and reduced crop yields—factors that have severely
                        weakened the country's capacity to produce adequate and affordable food.</br>
                        The Dry Zone, a region vital to Sri Lanka's food production and home to a significant proportion
                        of its farming population, is bearing the brunt of climate change. Erratic rainfall patterns,
                        extended droughts, and rising temperatures threaten both staple crop cultivation and farming
                        livelihoods.
                ...
                <div class="ratio ratio-4x3 w-100">
                    <img src="./assets/media/img/impact-areas/STA/sta-side-img-1.jpg" alt=""
                        class="object-fit-cover w-100 h-100" style="border-radius: 50rem 0 0 50rem;">
                </div>
            </div>
        </div>
        <div class="container my-5 solution">
            ...
            <div class="row row-cols-1 row-cols-lg-3 mb-5 justify-content-center">
                ...
                <!-- <div class="col d-flex text-center py-5">
                    <div class="flex-fill">
                        <img src="./assets/icons/stock-increase.svg" alt="" class="img-fluid mb-3"
                            style="height: 100px;">
            ...
            <div
                class="d-flex flex-column flex-md-row-reverse justify-content-center align-items-center overflow-hidden my-5" id="whatWeDo">
                <div class="d-flex flex-column  ps-0 ps-md-5 w-100 justify-content-center py-4 text-start">
                    ...
                    <ul class="list-group list-group-flush bg-white rounded">
                        ...
                        <li class="list-group-item">
                            <h5 class="fw-semibold">Climate smart agriculture</h5>
                            <p class="mb-0">
                                We work to enhance food security and climate resilience by introducing innovative
                                farming
                                techniques and technologies to rural communities. This includes promoting the use of
                                solar
                                powered irrigation systems, efficient water management, and climate-smart practices that
                                reduce input costs while improving yields.
                            </p>
                        </li>

                        <li class="list-group-item">
                            <h5 class="fw-semibold">Crop diversification</h5>
                            <p class="mb-0">
                                We promote crop diversification, intercropping, and agroforestry as key strategies to
                                improve
                                food security and climate resilience. By encouraging farmers to grow a wider range of
                                crops and
                                integrate trees into farming systems, these approaches enhance soil health, reduce pest
                                and
                                disease risks, and provide multiple sources of food and income.
                            </p>
                        </li>

                        <li class="list-group-item">
                            <h5 class="fw-semibold">Bio-intensive farming </h5>
                            <p class="mb-0">
                                We support the adoption of bio-intensive farming methods that focus on maximizing
                                productivity through sustainable practices. This includes soil sampling to guide
                                nutrient
                                management, on-farm composting to improve soil fertility, and low-cost organic inputs to
                ...
                <!-- Solution Image -->
                <div class="ratio ratio-4x3 w-100">
                    <img src="./assets/media/img/impact-areas/STA/sta-side-img-2.jpg" alt=""
                        class="object-fit-cover w-100 h-100" style="border-radius: 0 50rem 50rem 0;">
                </div>
            </div>
            ...
            <!-- <div class="row row-cols-1 row-cols-md-3">
                ...
                <div class="col d-flex text-center py-5">
                    <div class="flex-fill">
                        ...
                        <img src="./assets/icons/fluent_location-48-filled.svg" alt="" class="img-fluid mb-3"
                            style="height: 100px;">
                        <h4 class="fw-semibold text-dark-emphasis">Anuradhapura, Hambanthota, Kurunegala, Ampara,
                            Anuradhapura, Hambanthota, Kurunegala, Ampara</h4>
                    </div>
                </div>
                ...
                <div class="col d-flex text-center py-5">
                    <div class="flex-fill">
                        ...
                        <img src="./assets/icons/mingcute_calendar-fill.svg" alt="" class="img-fluid mb-3"
                            style="height: 100px;">
                        <h4 class="fw-semibold text-dark-emphasis">Community Based Organizations</h4>
                    </div>
                </div>
                ...
                <div class="col d-flex text-center py-5">
                    <div class="flex-fill">
                        ...
                        <img src="./assets/icons/ri_focus-2-fill.svg" alt="" class="img-fluid mb-3"
                            style="height: 100px;">
                        <h4 class="fw-semibold text-dark-emphasis">New Loans in 2025</h4>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 mb-3">                                    
                                    <div class="card border-0 h-100 position-relative">
                                        ...
                                        <div class="card-img-top" style="height: 332.8px; overflow: hidden;">
                                            ...
                                            <img src="./assets/media/img/ongoing-projects/criwmp2.png"
                            ...
                            <div class="col-md-4 mb-3">                                    
                                    <div class="card border-0 h-100 position-relative">
                                        ...
                                        <div class="card-img-top" style="height: 332.8px; overflow: hidden;">
                                            ...
                                            <!-- w-100 and h-100 make it fill the div. -->
                                            <!-- object-fit: cover tells it how to fill the space without distortion. -->
                                            <img src="./assets/media/img/past-projects/A Tank Based Biodiversity.png"
                                                alt="Project CodeKids"
                                                class="w-100 h-100 rounded-top-3"
                                                style="object-fit: cover;">
                                        </div>
                            ...
                            <div class="col-md-4 mb-3">                                    
                                    <div class="card border-0 h-100 position-relative">
                                        ...
                                        <div class="card-img-top" style="height: 332.8px; overflow: hidden;">
                                            ...
                                            <!-- w-100 and h-100 make it fill the div. -->
                                            <!-- object-fit: cover tells it how to fill the space without distortion. -->
                                            <img src="./assets/media/img/past-projects/Community Participatory Action to build resilience in response to drought and human elephant.png"
                                                alt="Project CodeKids"
                                                class="w-100 h-100 rounded-top-3"
                                                style="object-fit: cover;">
                                        </div>
                            ...
                            <div class="col-md-4 mb-3">                                    
                                    <div class="card border-0 h-100 position-relative">
                                        ...
                                        <div class="card-img-top" style="height: 332.8px; overflow: hidden;">
                                            ...
                                            <!-- w-100 and h-100 make it fill the div. -->
                                            <!-- object-fit: cover tells it how to fill the space without distortion. -->
                                            <img src="./assets/media/img/past-projects/Sustainable Agriculture and Global Exchange (SAGE) program.png"
                                                alt="Project CodeKids"
                                                class="w-100 h-100 rounded-top-3"
                                                style="object-fit: cover;">
                                        </div>
                            ...
                            <div class="col-md-4 mb-3">                                    
                                    <div class="card border-0 h-100 position-relative">
                                        ...
                                        <div class="card-img-top" style="height: 332.8px; overflow: hidden;">
                                            ...
                                            <!-- w-100 and h-100 make it fill the div. -->
                                            <!-- object-fit: cover tells it how to fill the space without distortion. -->
                                            <img src="./assets/media/img/past-projects/Peoples' Initiative for Responsible Management of Water Resources at Kudadodanathathawa.png"
                                                alt="Project CodeKids"
                                                class="w-100 h-100 rounded-top-3"
                                                style="object-fit: cover;">
                                        </div>
        ...
        <div class="w-100 overflow-hidden d-flex flex-column justify-content-center align-items-center mb-5 bg-dark"
            style="max-height: 439px;">
            <img src="./assets/media/img/impact-areas/STA/sta-strip-img-1.jpg"
                alt="sdg_img" class="object-fit-cover w-100 h-100">
        </div>
        <!-- success story -->
        <section class="container" id="success-stories" style="margin-bottom: 64px;">
            ...
            <div id="StoryCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div
                            class="story-card d-flex flex-column flex-md-row justify-content-center rounded-4 overflow-hidden">
                            <!-- story image -->
                            <div class="story-image overflow-hidden align-items-center">
                                <img src="./assets/media/img/impact-areas/STA/sta-scs-stry-img-2.png"
                                    alt="success_story_img" class="object-fit-cover w-100 h-100">
                            </div>
                            <!-- story text -->
                            <div class="story-text d-flex flex-column align-items-center justify-content-center p-5 h-100"
                                style="background: #EEEFF0;">
                                <div class="w-100">
                                    <img src="./assets/icons/Vector.svg" alt="People icon" class="img-fluid mb-2"
                                        style="max-width:32px;">
                                    <p class="text-center m-3 fw-bold fs-5 text-truncate-6">
                                        SAPSRI’s CRIWMP poultry program empowers vulnerable women through systematic free-range farming and low-cost incubation technology. By providing technical guidance, it enables single mothers to generate resilient supplementary income and upscale production, securing financial independence while balancing household responsibilities.
                                    </p>
                                    <span class="d-flex justify-content-end">
                                        <img src="./assets/icons/Vector (1).svg" alt="People icon" class="img-fluid mt-2"
                                            style="max-width:32px;">
                                    </span>
                                </div>
                                <p class="text-center m-3 fs-4">Free Range Poultry Farming</p>
                                <!-- <button class="btn bg-theme-accent rounded-pill py-3 px-4 fs-6 my-4">See story in
                                    detail</button> -->
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div
                            ...
                            <!-- story image -->
                            <div class="story-image overflow-hidden align-items-center">
                                <img src="./assets/media/img/impact-areas/STA/sta-scs-stry-img-1.png"
                                    alt="success_story_img" class="object-fit-cover w-100 h-100">
                            </div>
                            <!-- story text -->
                            <div class="story-text d-flex flex-column align-items-center justify-content-center p-5 h-100"
                                ...
                                <div class="w-100">
                                    <img src="./assets/icons/Vector.svg" alt="People icon" class="img-fluid mb-2"
                                        style="max-width:32px;">
                                    <p class="text-center m-3 fw-bold fs-5 text-truncate-6">
                                        The CRIWMP silage initiative combats seasonal fodder scarcity by training farmers in mechanized, collective silage production using drought-resistant crops. This gender-inclusive project ensures year-round cattle nutrition and significantly boosts milk yields, securing sustainable livelihoods for dairy farming communities.
                                    </p>
                                    <span class="d-flex justify-content-end">
                                        <img src="./assets/icons/Vector (1).svg" alt="People icon" class="img-fluid mt-2"
                                            style="max-width:32px;">
