...
<head>
    ...
    <style>
        ...
        .post-meta { color: var(--text-light-gray); font-size: 0.9rem; }
        .post-content h1 { font-weight: 700; }
        .post-content h2 { font-size: 1.75rem; color: #343a40; }
...
<body>
    ...
    <main style="margin-top: 56px; min-height: 70vh;">
        ...
        <div id="loading-container" class="container py-5 text-center d-flex flex-column align-items-center justify-content-center" style="min-height: 50vh;">
            <span class="spinner-border text-warning" style="width: 3rem; height: 3rem;" role="status"></span>
        ...
        <article class="post-content container py-5 d-none" id="dynamic-project-container">
            ...
            <nav class="d-flex justify-content-center justify-content-lg-end my-5 gap-4" aria-label="Blog post navigation">
                <!-- IMPORTANT: Points back to ongoing-projects -->
                <a href="ongoing-projects" class="btn btn-post-nav rounded-pill"><i class="bi bi-arrow-left me-2"></i>Back to Projects</a>
            </nav>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            if (!projectId) {
                document.getElementById('loading-container').innerHTML = `<h2 class="text-danger">Error: No project selected.</h2><a href="ongoing-projects" class="btn btn-dark mt-3">Go Back</a>`;
                return;
            }
            ...
            try {
                ...
                if (!project) {
                    document.getElementById('loading-container').innerHTML = `<h2 class="text-danger">Error: Project not found.</h2><a href="ongoing-projects" class="btn btn-dark mt-3">Go Back</a>`;
                    return;
                }
