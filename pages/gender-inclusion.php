...
<head>
    ...
    <style>
        ...
        /* --- Hero Section Styles --- */
        section.genInc-hero {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6)), url(./assets/media/img/impact-images/Gender\ Inc.png);
...
<body>
    ...
    <main>
        ...
        <section class="genInc-hero  mb-5">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center text-white justify-content-center d-flex flex-column align-items-center gap-2">
                        ...
                        <h1 class="fw-semibold mb-3 display-2">Gender Inclusion</h1>
                        <div style="width: 50%; max-width: 121.57px;  aspect-ratio: 1 / 1;" class="d-flex justify-content-center overflow-hidden align-items-center">
                            <img src="./assets/icons/category large icon set (2).svg" alt="" class="w-100 h-100 object-fit-cover">
                        </div>
        ...
        <div class="container my-5 problem" id="overview">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center overflow-hidden my-5">
                <div class="d-flex flex-column  pe-0 pe-md-5 w-100 justify-content-center py-4 text-start">
                    <h2 class="text-crimson fw-semibold mb-3">Gender Inclusion</h2>
                    <p>
                        <span class="fs-5 fw-semibold">Access to tailored financial services enables women to start or grow businesses, increase
                            income, and gain greater decision-making power within their families and communities,
                            driving positive social and economic change. </span></br></br>
                        Access to finance plays a vital role in empowering women in Sri Lanka, especially in rural and
                        underserved areas, where 11% of women access microfinance services compared to 8% of men.
                        Women often rely on community banks and informal financial channels for savings and credit,
                        which supports their income generation and decision-making capacity. However, challenges
                        remain, including over-indebtedness, limited financial literacy, and a significant digital gender
                        gap—with only about 1.2% of women using mobile money compared to 4.9% of men.
                        Addressing these barriers is essential to fully realize microfinance's potential to enhance
                        women's financial independence and inclusion in Sri Lanka.
        ...
        <div class="container my-5 solution">
            ...
            <div class="d-flex flex-column flex-md-row-reverse justify-content-center align-items-center overflow-hidden my-5" id="whatWeDo">
                <div class="d-flex flex-column  ps-0 ps-md-5 w-100 justify-content-center py-4 text-start">
                    ...
                    <ul class="list-group list-group-flush bg-white rounded">
                        ...
                        <li class="list-group-item">
                            <h5 class="fw-semibold">Community mobilisation</h5>
                            <p class="mb-0">
                                We bring together local groups—such as women's collectives, savings groups, or village
                                committees—to collectively organise, plan, and manage access to financial services. For women
                                this creates safe, supportive spaces where they can come together to build financial literacy,
                                share experiences, and access credit without traditional barriers like collateral requirements. By
                                organising collectively, women gain greater confidence, peer support, and bargaining power,
                                which helps overcome social and economic constraints—enabling them to participate more
                                fully in economic activities and decision-making processes.
                            </p>
                        </li>

                        <li class="list-group-item">
                            <h5 class="fw-semibold">Economic empowerment</h5>
                            <p class="mb-0">
                                We provide women with access to microloans which is invested into productive activities such
                                as agriculture, crafts, or trade, which can improve household food security and living standards.
                                Participation can often strengthen women's savings habits and creditworthiness, enabling
                                greater economic stability and the ability to cope with financial shocks.
                            </p>
                        </li>
                    </ul>
                    <!-- <button class="btn btn-primary rounded-pill">Discover more</button> -->
        ...
        <div class="w-100 overflow-hidden d-flex flex-column justify-content-center align-items-center mb-5 bg-dark" style="max-height: 439px;">
            <img src="./assets/media/img/ongoing-projects/smed3.jpeg" alt="sdg_img" class="object-fit-cover w-100 h-100">
        </div>
        <!-- success story -->
