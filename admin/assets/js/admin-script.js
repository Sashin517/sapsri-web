...
function openDeleteModal(itemId, itemName, itemType, endpointUrl, callbackFunctionName) {
    ...
    document.getElementById('deleteModalText').innerText = `Are you sure want to delete this ${itemType.toLowerCase()}? ${typeCapitalized} will delete permanently.`;
      ...
      function simulateUpload(idPrefix, callback) {
        ...
        const interval = setInterval(() => {
          ...
          if (progress === 100) {
            ...
            progressText.innerHTML = '<i data-lucide="check-circle" style="width:14px;"></i> Upload Complete!';
            lucide.createIcons();
            setTimeout(() => { progressDiv.style.display = 'none'; callback(); }, 800);
          }
        }, 100);
      }
        ...
        return new Promise((resolve) => {
          ...
          const interval = setInterval(() => {
            ...
            if (progress === 100) {
              ...
              setTimeout(() => { progressDiv.style.display = 'none'; resolve(); }, 700);
            }
          }, 100);
        });
      }
