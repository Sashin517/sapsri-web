            ...
            <div class="d-flex dual-cal-wrapper gap-4">
              ...
              <div class="flex-grow-1 border-end pe-md-4">
                ...
                <div class="cal-grid">
                  ...
                  <div class="cal-day muted">1</div>
                  <div class="cal-day muted">2</div>
                  <div class="cal-day muted">3</div>
                  <div class="cal-day muted">4</div>
                  <div class="cal-day muted">5</div>
                  <div class="cal-day muted">6</div>
                  <div class="cal-day muted">7</div>
                  <div class="cal-day muted">8</div>
                  <div class="cal-day muted">9</div>
                  <div class="cal-day muted">10</div>
                  <div class="cal-day muted">11</div>
                  <div class="cal-day muted">12</div>
                  <div class="cal-day muted">13</div>
                  <div class="cal-day muted">14</div>
                  <div class="cal-day muted">15</div>
                  <div class="cal-day muted">16</div>
                  <div class="cal-day muted">17</div>
                  <div class="cal-day muted">18</div>
                  <div class="cal-day muted">19</div>
                  <div class="cal-day muted">20</div>

                  <div class="cal-range-start">
                    <div class="cal-day">21</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">22</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">23</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">24</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">25</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">26</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">27</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">28</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">29</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">30</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">31</div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex-grow-1">
                ...
                <div class="cal-grid">
                  ...
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">1</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">2</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">3</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">4</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">5</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">6</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">7</div>
                  </div>
                  <div class="cal-range-bg">
                    <div class="cal-day text-dark">8</div>
                  </div>
                  <div class="cal-range-end">
                    <div class="cal-day fw-bold">9</div>
                  </div>
