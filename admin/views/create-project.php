...
<div class="px-4 pb-5">
  <form id="createProjectForm">
    ...
    <div class="section-card">
      ...
      <div class="mb-4">
        ...
        <div class="upload-area" onclick="document.getElementById('sec1Input').click()">
          ...
          <!-- Progress UI -->
            <div class="upload-progress-wrapper" id="sec1Progress">
          ...
          <div class="image-preview-wrapper" id="sec1PreviewWrapper">
      ...
      <div id="metricsContainerSec1">
        <!-- Metric Rows Injected Here -->
      </div>
    </div>
    ...
    <div class="section-card">
      ...
      <div class="mb-4">
        ...
        <div class="upload-area" onclick="document.getElementById('sec2Input').click()">
          ...
          <!-- NEW: Progress UI -->
          <div class="upload-progress-wrapper" id="sec2Progress">
          ...
          <div class="image-preview-wrapper" id="sec2PreviewWrapper">
      ...
      <div style="flex: 1;">
        ...
        <div class="upload-area" style="padding: 2rem;" onclick="document.getElementById('leadInput').click()">
          <div class="upload-content" id="leadContent">
            ...
            <div class="upload-progress-wrapper" id="leadProgress">
          ...
          <div class="image-preview-wrapper round-preview" id="leadPreviewWrapper">
    ...
    <div class="section-card">
      ...
      <!-- Grid for dynamically added gallery previews -->
